...
export default {
  ...
  generateWelcomeMail: (data, callback) => axios
  ...
  generateInvoiceMail: (data, callback) => axios
  ...
  // get All Couple
  searchCouple: (data, callback) => axios
    .get(`${adminUrl}Couple/`, { params: data })
    .then((responseData) => {
      callback(responseData);
    })
    .catch((err) => {
  ...
  // update Couple
  updateCouple: (id, data, callback) => axios
    .put(`${adminUrl}Couple/updateCouple/${id}`, data)
    .then((responseData) => {
      callback(responseData);
    })
    .catch((err) => {
  ...
  // save Couple
  saveCouple: (data, callback) => axios
    .post(`${adminUrl}Couple/saveCouple`, data)
    .then((responseData) => {
      callback(responseData);
    })
    .catch((err) => {
  ...
  // delete Couple
  deleteCouple: (id, callback) => axios
    .delete(`${adminUrl}Couple/deleteCouple/${id}`)
    .then((responseData) => {
      callback(responseData);
    })
    .catch((err) => {
  ...
  // get one Couple
  getOneCouple: (id, callback) => axios
    .get(`${adminUrl}Couple/getOne/${id}`)
    .then((responseData) => {
      callback(responseData);
    })
    .catch((err) => {
  ...
  generateWelcomeCoupleMail: (data, callback) => axios
    .post(`${adminUrl}Couple/generateWelcomeMail`, data)
    .then((responseData) => {
      callback(responseData);
    })
    .catch((err) => {
  ...
  generateInvoiceCoupleMail: (data, callback) => axios
    .post(`${adminUrl}Couple/generateInvoiceMail`, data)
    .then((responseData) => {
      callback(responseData);
    })
    .catch((err) => {
  ...
  // get All TeamList
  searchTeamList: (data, callback) => axios
  ...
  // update TeamList
  updateTeamList: (id, data, callback) => axios
  ...
  // save TeamList
  saveTeamList: (data, callback) => axios
  ...
  // delete TeamList
  deleteTeamList: (id, callback) => axios
  ...
  // get one TeamList
  getOneTeamList: (id, callback) => axios
  ...
  generatePlayerExcel: (reportData, filename, callback) => axios({
  ...
  generateInvoicePdf: (formData, callback) => axios
